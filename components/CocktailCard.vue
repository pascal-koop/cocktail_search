...
<template>
  <div
    class="container font-roboto w-80 rounded-xl drop-shadow-lg bg-fuchsia-50 py-1 my-8 mx-auto border border-stone-300"
  >
    <h1
      class="p-3 text-zinc-900 text-base font-thin leading-normal tracking-tight"
    >
      {{ title }}
    </h1>
